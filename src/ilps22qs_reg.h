...
int32_t ilps22qs_read_reg(const ilps22qs_ctx_t *ctx, uint8_t reg,
                          uint8_t *data, uint16_t len);
int32_t ilps22qs_write_reg(const ilps22qs_ctx_t *ctx, uint8_t reg,
                           uint8_t *data, uint16_t len);
...
int32_t ilps22qs_id_get(const ilps22qs_ctx_t *ctx, ilps22qs_id_t *val);
...
int32_t ilps22qs_bus_mode_set(const ilps22qs_ctx_t *ctx, ilps22qs_bus_mode_t *val);
int32_t ilps22qs_bus_mode_get(const ilps22qs_ctx_t *ctx, ilps22qs_bus_mode_t *val);
...
int32_t ilps22qs_init_set(const ilps22qs_ctx_t *ctx, ilps22qs_init_t val);
...
int32_t ilps22qs_status_get(const ilps22qs_ctx_t *ctx, ilps22qs_stat_t *val);

typedef struct {
  uint8_t sda_pull_up : 1; /* 1 = pull-up enabled */
  uint8_t cs_pull_up  : 1; /* 1 = pull-up enabled */
} ilps22qs_pin_conf_t;
int32_t ilps22qs_pin_conf_set(const ilps22qs_ctx_t *ctx, ilps22qs_pin_conf_t *val);
int32_t ilps22qs_pin_conf_get(const ilps22qs_ctx_t *ctx, ilps22qs_pin_conf_t *val);
...
int32_t ilps22qs_all_sources_get(const ilps22qs_ctx_t *ctx, ilps22qs_all_sources_t *val);
...
int32_t ilps22qs_mode_set(const ilps22qs_ctx_t *ctx, ilps22qs_md_t *val);
int32_t ilps22qs_mode_get(const ilps22qs_ctx_t *ctx, ilps22qs_md_t *val);

int32_t ilps22qs_trigger_sw(const ilps22qs_ctx_t *ctx, ilps22qs_md_t *md);
...
int32_t ilps22qs_data_get(const ilps22qs_ctx_t *ctx, ilps22qs_md_t *md,
                          ilps22qs_data_t *data);

int32_t ilps22qs_pressure_raw_get(const ilps22qs_ctx_t *ctx, uint32_t *buff);
int32_t ilps22qs_temperature_raw_get(const ilps22qs_ctx_t *ctx, int16_t *buff);
...
int32_t ilps22qs_ah_qvar_data_get(const ilps22qs_ctx_t *ctx,
...
int32_t ilps22qs_fifo_mode_set(const ilps22qs_ctx_t *ctx, ilps22qs_fifo_md_t *val);
int32_t ilps22qs_fifo_mode_get(const ilps22qs_ctx_t *ctx, ilps22qs_fifo_md_t *val);

int32_t ilps22qs_fifo_level_get(const ilps22qs_ctx_t *ctx, uint8_t *val);
...
int32_t ilps22qs_fifo_data_get(const ilps22qs_ctx_t *ctx, uint8_t samp,
                               ilps22qs_md_t *md, ilps22qs_fifo_data_t *data);

typedef struct {
  uint8_t int_latched  : 1; /* int events are: int on threshold, FIFO */
} ilps22qs_int_mode_t;
int32_t ilps22qs_interrupt_mode_set(const ilps22qs_ctx_t *ctx, ilps22qs_int_mode_t *val);
int32_t ilps22qs_interrupt_mode_get(const ilps22qs_ctx_t *ctx, ilps22qs_int_mode_t *val);

int32_t ilps22qs_ah_qvar_disable(const ilps22qs_ctx_t *ctx);
int32_t ilps22qs_ah_qvar_en_set(const ilps22qs_ctx_t *ctx, uint8_t val);
int32_t ilps22qs_ah_qvar_en_get(const ilps22qs_ctx_t *ctx, uint8_t *val);
...
int32_t ilps22qs_int_on_threshold_mode_set(const ilps22qs_ctx_t *ctx,
                                           ilps22qs_int_th_md_t *val);
int32_t ilps22qs_int_on_threshold_mode_get(const ilps22qs_ctx_t *ctx,
                                           ilps22qs_int_th_md_t *val);
...
int32_t ilps22qs_reference_mode_set(const ilps22qs_ctx_t *ctx,
                                    ilps22qs_ref_md_t *val);
int32_t ilps22qs_reference_mode_get(const ilps22qs_ctx_t *ctx,
                                    ilps22qs_ref_md_t *val);

int32_t ilps22qs_opc_set(const ilps22qs_ctx_t *ctx, int16_t val);
int32_t ilps22qs_opc_get(const ilps22qs_ctx_t *ctx, int16_t *val);
